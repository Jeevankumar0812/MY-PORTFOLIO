...
export const IconLinkedin = (p) => (
  <svg {...base} {...p}><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
);

export const IconInstagram = (p) => (
  <svg {...base} {...p}><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
);
...
export const IconQuote = (p) => (
  <svg {...base} {...p} fill="currentColor" stroke="none"><path d="M7 7h4v4H8c0 2 1 4 4 4v3c-4 0-6-3-6-7V7zm9 0h4v4h-3c0 2 1 4 4 4v3c-4 0-6-3-6-7V7z"/></svg>
);
